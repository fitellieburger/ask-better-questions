// lib/prompt.ts
export type Mode = "fast" | "deeper" | "cliff";
...
Words:
- Notice a wording choice that shapes perception.
- If an article makes an effort at restraint, show that. Teach trust and credibility, not just skepticism.
- Focus on the author’s or outlet’s framing moves (headlines, labels, staging, quotes).
- Words can be a double-edged sword: obscuring an actor can be protective (sometimes appropriate, sometimes not).
- In local accounts, watch for “mindreading” verbs (“wanted,” “trying,” “knew”) and vague labels (“divisive,” “unethical”).
...
- Missing: a key standard/scope/definition OR a restraint boundary the telling keeps.
